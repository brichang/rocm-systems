...
function(write_install_test_definition TEST_NAME TEST_COMMAND TEST_LABELS TEST_TIMEOUT TEST_RANKS)
    ...
    foreach(part IN LISTS TEST_COMMAND)
        ...
        elseif("${part}" STREQUAL "$<TARGET_FILE:rocshmem_functional_tests>")
            # Executable is at: <install>/libexec/rocshmem/rocshmem_functional_tests
            # Relative from working dir: ../../../../libexec/rocshmem/rocshmem_functional_tests
            list(APPEND INSTALL_CMD_PARTS "../../../../libexec/rocshmem/rocshmem_functional_tests")
