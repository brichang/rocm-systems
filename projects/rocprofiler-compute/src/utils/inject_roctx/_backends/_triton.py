...
Wraps triton.compiler.CompiledKernel.__call__ so Triton/Inductor launches
appear in ROCTX markers. Independent of the torch backend; the two share
only the _core push/pop API.
"""
